...
def talker():
    ...
    cmd = raw_input("Enter details in this format:queuePickupDropoff <goal1Name> <goal2Name> [priority1 or "default"] [priority2 or "default"] [jobId]\r\nqueuePickupDropoff ")
    ...
    while (flag == 0):
        if "End of commands" in rcv:
            ...
            while not rospy.is_shutdown():
                command = "queuePickupDropoff {}".format(cmd)
