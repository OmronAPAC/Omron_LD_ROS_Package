...
def talker():
    ...
    global s
    global data
    pub = rospy.Publisher('arcl_play', String, queue_size=10)
    rospy.init_node('talker', anonymous=True)
    rate = rospy.Rate(10) # 10hz

    socketconnect()

    cmd = raw_input("Enter the path and name of the sound file with the .wav extension.\r\nFiles in subfolders must be use a forward slash between folder names,\r\nfor example: /subfolder1/subfolder2/wavefile.wav:\r\n")    
