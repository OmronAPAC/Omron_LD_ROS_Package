...
def talker():
    ...
    global s
    global data
    pub = rospy.Publisher('arcl_queueMulti', String, queue_size=10)
    rospy.init_node('talker', anonymous=True)
    rate = rospy.Rate(10) # 10hz

    socketconnect()

    cmd = raw_input("Enter details in this format:queueMulti <number of goals> <number of fields per goal> <goal1> <goal1 args> <goal2> <goal2 args> ... <goalN> <goalN args> [jobid]\r\nqueueMulti ")
