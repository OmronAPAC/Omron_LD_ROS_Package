...
def talker():
    ...
    global s
    global data
    pub = rospy.Publisher('arcl_patrolResume', String, queue_size=10)
    rospy.init_node('talker', anonymous=True)
    rate = rospy.Rate(10) # 10hz

    socketconnect()

    cmd = raw_input("Enter the name of the route you want the robot to continue patrolling: ")
    ...
    while (flag == 0):
        if "End of commands" in rcv:
            ...
            while not rospy.is_shutdown():
                command = "patrolResume {}".format(cmd)
