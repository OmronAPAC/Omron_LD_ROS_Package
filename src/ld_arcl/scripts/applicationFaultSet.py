...
class commandtosend:
     command = raw_input("Enter fault to set in this format: applicationFaultSet <name> <short_description> <long_description> <bool_driving> <bool_critical>\r\napplicationFaultSet ")    
    ...
    while (flag == 0):
        if "End of commands" in rcv:
            ...
            while not rospy.is_shutdown():
                cmd = "applicationFaultSet {}".format(sendcommand.command)
