...
(cl:defmethod cl:initialize-instance :after ((m <PatrolFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PatrolFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name om_aiv_navigation-msg:<PatrolFeedback> is deprecated: use om_aiv_navigation-msg:PatrolFeedback instead.")))

(cl:ensure-generic-function 'received_data-val :lambda-list '(m))
(cl:defmethod received_data-val ((m <PatrolFeedback>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PatrolFeedback>)))
  ...
  "om_aiv_navigation/PatrolFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PatrolFeedback)))
  "Returns string type for a message object of type 'PatrolFeedback"
  "om_aiv_navigation/PatrolFeedback")
