...
(defsystem "om_aiv_navigation-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "QueueDropoffAction" :depends-on ("_package_QueueDropoffAction"))
    (:file "_package_QueueDropoffAction" :depends-on ("_package"))
    (:file "QueueDropoffActionFeedback" :depends-on ("_package_QueueDropoffActionFeedback"))
    (:file "_package_QueueDropoffActionFeedback" :depends-on ("_package"))
    (:file "QueueDropoffActionGoal" :depends-on ("_package_QueueDropoffActionGoal"))
    (:file "_package_QueueDropoffActionGoal" :depends-on ("_package"))
    (:file "QueueDropoffActionResult" :depends-on ("_package_QueueDropoffActionResult"))
    (:file "_package_QueueDropoffActionResult" :depends-on ("_package"))
    (:file "QueueDropoffFeedback" :depends-on ("_package_QueueDropoffFeedback"))
    (:file "_package_QueueDropoffFeedback" :depends-on ("_package"))
    (:file "QueueDropoffGoal" :depends-on ("_package_QueueDropoffGoal"))
    (:file "_package_QueueDropoffGoal" :depends-on ("_package"))
    (:file "QueueDropoffResult" :depends-on ("_package_QueueDropoffResult"))
    (:file "_package_QueueDropoffResult" :depends-on ("_package"))
