...
class ExecuteMacroActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new ExecuteMacroGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExecuteMacroGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ExecuteMacroGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteMacroActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ExecuteMacroGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ExecuteMacroGoal()
    }
...
module.exports = ExecuteMacroActionGoal;
