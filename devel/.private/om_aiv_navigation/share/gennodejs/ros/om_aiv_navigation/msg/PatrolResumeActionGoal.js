...
class PatrolResumeActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new PatrolResumeGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PatrolResumeGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PatrolResumeGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PatrolResumeActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PatrolResumeGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PatrolResumeGoal()
    }
...
module.exports = PatrolResumeActionGoal;
