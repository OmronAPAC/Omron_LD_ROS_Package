...
"""autogenerated by genpy from om_aiv_navigation/DockAction.msg. Do not edit."""
import sys
...
class DockAction(genpy.Message):
  _md5sum = "15a9432413cdda89a7fa17f9943cc653"
  _type = "om_aiv_navigation/DockAction"
...
"""
  ...
  _slot_types = ['om_aiv_navigation/DockActionGoal','om_aiv_navigation/DockActionResult','om_aiv_navigation/DockActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = om_aiv_navigation.msg.DockActionGoal()
      if self.action_result is None:
        self.action_result = om_aiv_navigation.msg.DockActionResult()
      if self.action_feedback is None:
        self.action_feedback = om_aiv_navigation.msg.DockActionFeedback()
    else:
      self.action_goal = om_aiv_navigation.msg.DockActionGoal()
      self.action_result = om_aiv_navigation.msg.DockActionResult()
      self.action_feedback = om_aiv_navigation.msg.DockActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.goal_dock
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_dock = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.goal_dock = str[start:end]
      _x = self
      start = end
      end += 12
