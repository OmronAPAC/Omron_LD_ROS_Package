...
"""autogenerated by genpy from om_aiv_navigation/UndockAction.msg. Do not edit."""
import sys
...
class UndockAction(genpy.Message):
  _md5sum = "506c20c9bda111b9a99a7b45e06aeee7"
  _type = "om_aiv_navigation/UndockAction"
...
"""
  ...
  _slot_types = ['om_aiv_navigation/UndockActionGoal','om_aiv_navigation/UndockActionResult','om_aiv_navigation/UndockActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = om_aiv_navigation.msg.UndockActionGoal()
      if self.action_result is None:
        self.action_result = om_aiv_navigation.msg.UndockActionResult()
      if self.action_feedback is None:
        self.action_feedback = om_aiv_navigation.msg.UndockActionFeedback()
    else:
      self.action_goal = om_aiv_navigation.msg.UndockActionGoal()
      self.action_result = om_aiv_navigation.msg.UndockActionResult()
      self.action_feedback = om_aiv_navigation.msg.UndockActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.goal_undock
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_undock = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.goal_undock = str[start:end]
      _x = self
      start = end
      end += 12
