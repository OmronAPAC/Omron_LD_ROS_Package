...
"""autogenerated by genpy from om_aiv_navigation/StopAction.msg. Do not edit."""
import sys
...
class StopAction(genpy.Message):
  _md5sum = "d09d0dddd7d6b084107119bc751d04e2"
  _type = "om_aiv_navigation/StopAction"
...
"""
  ...
  _slot_types = ['om_aiv_navigation/StopActionGoal','om_aiv_navigation/StopActionResult','om_aiv_navigation/StopActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = om_aiv_navigation.msg.StopActionGoal()
      if self.action_result is None:
        self.action_result = om_aiv_navigation.msg.StopActionResult()
      if self.action_feedback is None:
        self.action_feedback = om_aiv_navigation.msg.StopActionFeedback()
    else:
      self.action_goal = om_aiv_navigation.msg.StopActionGoal()
      self.action_result = om_aiv_navigation.msg.StopActionResult()
      self.action_feedback = om_aiv_navigation.msg.StopActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.goal_stop
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_stop = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.goal_stop = str[start:end]
      _x = self
      start = end
      end += 12
