...
"""autogenerated by genpy from om_aiv_navigation/ExecuteMacroAction.msg. Do not edit."""
import sys
...
class ExecuteMacroAction(genpy.Message):
  _md5sum = "2b841be441a5840eadc7a10b1018fcbf"
  _type = "om_aiv_navigation/ExecuteMacroAction"
...
"""
  ...
  _slot_types = ['om_aiv_navigation/ExecuteMacroActionGoal','om_aiv_navigation/ExecuteMacroActionResult','om_aiv_navigation/ExecuteMacroActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteMacroAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = om_aiv_navigation.msg.ExecuteMacroActionGoal()
      if self.action_result is None:
        self.action_result = om_aiv_navigation.msg.ExecuteMacroActionResult()
      if self.action_feedback is None:
        self.action_feedback = om_aiv_navigation.msg.ExecuteMacroActionFeedback()
    else:
      self.action_goal = om_aiv_navigation.msg.ExecuteMacroActionGoal()
      self.action_result = om_aiv_navigation.msg.ExecuteMacroActionResult()
      self.action_feedback = om_aiv_navigation.msg.ExecuteMacroActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.goal_macro
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_macro = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.goal_macro = str[start:end]
      _x = self
      start = end
      end += 12
