...
"""autogenerated by genpy from om_aiv_navigation/PlayActionResult.msg. Do not edit."""
import sys
...
class PlayActionResult(genpy.Message):
  ...
  _type = "om_aiv_navigation/PlayActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','om_aiv_navigation/PlayResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = om_aiv_navigation.msg.PlayResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = om_aiv_navigation.msg.PlayResult()
