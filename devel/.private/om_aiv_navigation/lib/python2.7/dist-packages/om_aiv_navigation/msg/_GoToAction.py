...
"""autogenerated by genpy from om_aiv_navigation/GoToAction.msg. Do not edit."""
import sys
...
class GoToAction(genpy.Message):
  _md5sum = "48df76b661897309a256a6be211a5f71"
  _type = "om_aiv_navigation/GoToAction"
...
"""
  ...
  _slot_types = ['om_aiv_navigation/GoToActionGoal','om_aiv_navigation/GoToActionResult','om_aiv_navigation/GoToActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = om_aiv_navigation.msg.GoToActionGoal()
      if self.action_result is None:
        self.action_result = om_aiv_navigation.msg.GoToActionResult()
      if self.action_feedback is None:
        self.action_feedback = om_aiv_navigation.msg.GoToActionFeedback()
    else:
      self.action_goal = om_aiv_navigation.msg.GoToActionGoal()
      self.action_result = om_aiv_navigation.msg.GoToActionResult()
      self.action_feedback = om_aiv_navigation.msg.GoToActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.goal_goto
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_goto = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.goal_goto = str[start:end]
      _x = self
      start = end
      end += 12
