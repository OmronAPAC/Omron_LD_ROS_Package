...
(cl:defmethod cl:initialize-instance :after ((m <DockResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DockResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ld_actions-msg:<DockResult> is deprecated: use ld_actions-msg:DockResult instead.")))

(cl:ensure-generic-function 'docking_status-val :lambda-list '(m))
(cl:defmethod docking_status-val ((m <DockResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ld_actions-msg:docking_status-val is deprecated.  Use ld_actions-msg:docking_status instead.")
  (docking_status m))
