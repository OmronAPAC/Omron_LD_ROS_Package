...
(cl:defclass <DockActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type ld_actions-msg:DockGoal
    :initform (cl:make-instance 'ld_actions-msg:DockGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DockActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DockActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ld_actions-msg:<DockActionGoal> is deprecated: use ld_actions-msg:DockActionGoal instead.")))
