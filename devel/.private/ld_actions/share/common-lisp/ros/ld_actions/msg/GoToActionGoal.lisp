...
(cl:defclass <GoToActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type ld_actions-msg:GoToGoal
    :initform (cl:make-instance 'ld_actions-msg:GoToGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GoToActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoToActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ld_actions-msg:<GoToActionGoal> is deprecated: use ld_actions-msg:GoToActionGoal instead.")))
