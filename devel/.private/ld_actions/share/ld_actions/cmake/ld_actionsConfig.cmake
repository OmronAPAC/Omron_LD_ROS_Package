...
if(NOT "/home/tthmatt/ld_ROS/devel/.private/ld_actions/include " STREQUAL " ")
  set(ld_actions_INCLUDE_DIRS "")
  set(_include_dirs "/home/tthmatt/ld_ROS/devel/.private/ld_actions/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ld_actions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tthmatt/ld_ROS/src/ld_actions/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tthmatt/ld_ROS/devel/.private/ld_actions/lib;/home/tthmatt/ld_ROS/devel/lib;/home/tthmatt/ws/devel/lib;/home/tthmatt/catkin_ws/devel/lib;/opt/ros/melodic/lib)
