...
struct MD5Sum< ::ld_actions::DockActionGoal_<ContainerAllocator> >
{
  ...
  {
    return "7f56b7d7cac79caf0d63dd871c072fcd";
  }

  static const char* value(const ::ld_actions::DockActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7f56b7d7cac79cafULL;
  static const uint64_t static_value2 = 0x0d63dd871c072fcdULL;
};
