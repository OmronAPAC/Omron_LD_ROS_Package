...
struct MD5Sum< ::ld_actions::DockAction_<ContainerAllocator> >
{
  ...
  {
    return "38807df53975b22b832b949f5db45cbb";
  }

  static const char* value(const ::ld_actions::DockAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x38807df53975b22bULL;
  static const uint64_t static_value2 = 0x832b949f5db45cbbULL;
};
