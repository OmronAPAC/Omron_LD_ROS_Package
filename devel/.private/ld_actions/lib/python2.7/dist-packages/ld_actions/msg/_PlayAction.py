...
"""autogenerated by genpy from ld_actions/PlayAction.msg. Do not edit."""
import sys
...
class PlayAction(genpy.Message):
  _md5sum = "d6f2e876613403d8a89eb59fe3ea9bf7"
  _type = "ld_actions/PlayAction"
...
"""
  ...
  _slot_types = ['ld_actions/PlayActionGoal','ld_actions/PlayActionResult','ld_actions/PlayActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = ld_actions.msg.PlayActionGoal()
      if self.action_result is None:
        self.action_result = ld_actions.msg.PlayActionResult()
      if self.action_feedback is None:
        self.action_feedback = ld_actions.msg.PlayActionFeedback()
    else:
      self.action_goal = ld_actions.msg.PlayActionGoal()
      self.action_result = ld_actions.msg.PlayActionResult()
      self.action_feedback = ld_actions.msg.PlayActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.goal_play
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_play = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.goal_play = str[start:end]
      _x = self
      start = end
      end += 12
