...
"""autogenerated by genpy from ld_actions/DockActionFeedback.msg. Do not edit."""
import sys
...
class DockActionFeedback(genpy.Message):
  ...
  _type = "ld_actions/DockActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ld_actions/DockFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = ld_actions.msg.DockFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ld_actions.msg.DockFeedback()
