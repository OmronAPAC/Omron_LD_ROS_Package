...
"""autogenerated by genpy from ld_actions/DockActionResult.msg. Do not edit."""
import sys
...
class DockActionResult(genpy.Message):
  ...
  _type = "ld_actions/DockActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ld_actions/DockResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = ld_actions.msg.DockResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ld_actions.msg.DockResult()
