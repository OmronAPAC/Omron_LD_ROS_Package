...
"""autogenerated by genpy from ld_actions/GoToActionResult.msg. Do not edit."""
import sys
...
class GoToActionResult(genpy.Message):
  ...
  _type = "ld_actions/GoToActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ld_actions/GoToResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = ld_actions.msg.GoToResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ld_actions.msg.GoToResult()
