...
(cl:defmethod cl:initialize-instance :after ((m <Point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name om_aiv_util-msg:<Point> is deprecated: use om_aiv_util-msg:Point instead.")))
...
(cl:defmethod z-val ((m <Point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader om_aiv_util-msg:z-val is deprecated.  Use om_aiv_util-msg:z instead.")
  (z m))
