...
(cl:defclass <DockActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type actions_tutorial-msg:DockGoal
    :initform (cl:make-instance 'actions_tutorial-msg:DockGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DockActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DockActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name actions_tutorial-msg:<DockActionGoal> is deprecated: use actions_tutorial-msg:DockActionGoal instead.")))
...
(cl:defmethod goal_id-val ((m <DockActionGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader actions_tutorial-msg:goal_id-val is deprecated.  Use actions_tutorial-msg:goal_id instead.")
  (goal_id m))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <DockActionGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader actions_tutorial-msg:goal-val is deprecated.  Use actions_tutorial-msg:goal instead.")
  (goal m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DockActionGoal>)))
  ...
  "actions_tutorial/DockActionGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DockActionGoal)))
  "Returns string type for a message object of type 'DockActionGoal"
  "actions_tutorial/DockActionGoal")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DockActionGoal>)))
  ...
  "ab20958e4b47be382e784efd9206b3bb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DockActionGoal)))
  "Returns md5sum for a message object of type 'DockActionGoal"
  "ab20958e4b47be382e784efd9206b3bb")
